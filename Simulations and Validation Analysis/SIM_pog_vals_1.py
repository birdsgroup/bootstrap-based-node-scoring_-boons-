...
# %% VALIDATION -- Observed and Bootstrap Dataset -- ObsDI 
POG_vals = dict()
for s in SampleSizes:
    ...
    POG_vals[str(s)] = fun(parameters, parameters_pop, klim, s, n = len(order), plottype='cat', analysistype='V', path='')

filename = 'Simulated Data/POG Values_validation.xlsx'
